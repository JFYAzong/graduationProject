...
import { computed, ref, reactive, watch, PropType, inject } from "vue";
...
const videoUploadSuccess = inject("videoUploadSuccess");
const picUploadSuccess = inject("picUploadSuccess");
const afterUpload = () => {
	console.log("11111", props);
	if (props.type === "file") {
		console.log("2222file", videoUploadSuccess.value);
		videoUploadSuccess.value -= 1;
	}
	if (props.type === "image") {
		console.log("2222image", picUploadSuccess.value);
		picUploadSuccess.value -= 1;
	}
};
